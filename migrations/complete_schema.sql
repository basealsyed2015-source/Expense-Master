-- Complete schema reset and recreate
-- WARNING: This is destructive. It drops all tables/views/triggers listed below.

PRAGMA foreign_keys = OFF;

BEGIN TRANSACTION;

-- NOTE: We only drop tables below; no data wipe since some tables may not exist yet.
