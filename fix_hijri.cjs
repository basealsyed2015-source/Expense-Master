...
function makeAddScript(prefix, ids, syncVar) {
  ...
  return [
    ...
    i + "  var parts = new Intl.DateTimeFormat('en-u-ca-islamic-umalqura', { year: 'numeric', month: '2-digit', day: '2-digit' }).formatToParts(d);",
