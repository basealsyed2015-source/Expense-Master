-- ════════════════════════════════════════════════
-- 🔧 سكريبت إعادة بناء قاعدة البيانات - نسخة نظيفة
-- ════════════════════════════════════════════════
-- الغرض: حذف كل شيء وإعادة البناء من الصفر
-- ════════════════════════════════════════════════

-- ════════════════════════════════════════════════
-- 🗑️ المرحلة 1: حذف جميع الجداول القديمة
-- ════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════
-- 📊 المرحلة 3: إضافة البيانات الأساسية
-- ════════════════════════════════════════════════

-- الأدوار (Roles) - بأرقام 11, 12, 13, 14
...
-- المستخدمون (Users)
-- مدير النظام SaaS (ID = 11, Role = 11)
...
UNION ALL
SELECT '✅ Banks created:', COUNT(*) FROM banks
UNION ALL
SELECT '✅ Customers created:', COUNT(*) FROM customers
UNION ALL
SELECT '✅ Rates created:', COUNT(*) FROM rates
UNION ALL
SELECT '✅ Requests created:', COUNT(*) FROM financing_requests;

-- عرض مدير النظام
SELECT 
    '🎯 SaaS Admin User:' as info,
    id,
    username,
    password,
    role_id,
...
-- ════════════════════════════════════════════════
-- 🎉 تم! يمكنك الآن تسجيل الدخول:
-- ════════════════════════════════════════════════
-- URL: https://tamweel-calc.com/login
-- Username: saas_admin
